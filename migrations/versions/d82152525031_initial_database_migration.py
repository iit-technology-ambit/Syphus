...
Revision ID: d82152525031
Revises: 
Create Date: 2019-07-24 16:59:21.920313
...
def upgrade():
    ...
    sa.Column('fb_handle', sa.String(length=256), nullable=True),
    sa.Column('g_handle', sa.String(length=256), nullable=True),
    sa.Column('medium_handle', sa.String(length=256), nullable=True),
    sa.Column('twitter_handle', sa.String(length=256), nullable=True),
    sa.Column('linkedin_handle', sa.String(length=256), nullable=True),
    ...
    sa.ForeignKeyConstraint(['author_id'], ['user.username'], ),
    ...
    sa.ForeignKeyConstraint(['img_id'], ['imgLink.img_id'], ),
